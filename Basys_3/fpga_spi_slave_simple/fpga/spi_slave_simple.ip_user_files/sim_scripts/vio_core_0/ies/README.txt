...
#
# Generated by export_simulation on Sun Aug 05 14:28:38 EAT 2018
#
################################################################################
...
'-reset_run' switch to the './vio_core_0.sh' script.

./vio_core_0.sh -reset_run
...
./vio_core_0.sh -noclean_files

For more information on the script, please type './vio_core_0.sh -help'.
