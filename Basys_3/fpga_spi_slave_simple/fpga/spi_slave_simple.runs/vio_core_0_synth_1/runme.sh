...
HD_PWD='/home/alois/Documents/projects/FPGA/Basys_3/fpga_spi_slave_simple/fpga/spi_slave_simple.runs/vio_core_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_core_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_core_0.tcl
